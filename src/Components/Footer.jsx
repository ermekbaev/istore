...
const Footer = () => {
  return (
    <div className="pt-20 px-16 pb-20 bg-black text-gray-200">
      <div className="flex">
        <div className="w-3/12 pr-10.5">
          ...
          <p className="text-slate-400 text-base py-6 ">
            The largest NFT Marketplace. Unique and <br></br> authentic digital
            creations. Made possible <br></br> by blockchain technology.
          </p>
